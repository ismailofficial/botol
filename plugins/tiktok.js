...
let handler = async (m, { conn, args }) => {
  ...
  let res = await fetch(global.API('https://api.vhtear.com/tiktokdl?link=https://www.tiktok.com/@goodponsel/video/6913737919450729729&apikey=NOT-PREMIUM', '/dl/tiktok', {
    url: args[0]
  }, 'APIKEY'))
